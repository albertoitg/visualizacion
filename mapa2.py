...
norm = plt.Normalize(vmin=307293.2316, vmax=2022889.588)
data['color_hex'] = data['SUELDO'].apply(lambda x: mcolors.to_hex(colormap(norm(x))))
...
tree.write(f"mapa_heatmap_SUELDO_{modelo[modelo_seleccionado - 1]}.svg")
